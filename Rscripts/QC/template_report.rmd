...
plotSummaryNewFlags(flags_summary, sample_order)
...
```{r}
library(DT)
datatable(total_table, class = 'cell-border compact stripe', extensions = 'FixedColumns',
  options = list(
    dom = 't',
    scrollX = TRUE,
...
pic_path <- paste(input_installdir, "/Rscripts/QC/pipeline.png", sep = "")
